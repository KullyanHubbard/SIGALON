...
export function PublicSidebar({ nav, open, onClose }: PublicSidebarProps) {
  return (
    <>
      ...
      <aside
        className={cn(
          'fixed inset-y-0 left-0 z-40 flex h-full max-h-dvh min-h-0 w-72 sm:w-80 max-w-[85vw] flex-col border-r border-slate-200 bg-surface transition-transform lg:static lg:z-auto lg:col-start-1 lg:row-start-1 lg:h-full lg:max-h-full lg:w-auto lg:translate-x-0',
