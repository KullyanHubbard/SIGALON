      ...
      <div className="w-full">
        ...
        <div className={cn((icon || trailing) && 'relative')}>
          ...
          <input
            ...
            id={inputId}
            className={cn(
              'focus-ring h-10 w-full rounded-lg border-1 border-black bg-surface px-3 text-base sm:text-sm text-slate-900 transition-all duration-150 placeholder:text-slate-400 hover:border-black focus:border-brand-600 focus-visible:ring-brand-600/20',
              icon && 'pl-10',
              trailing && 'pr-11',
              error &&
